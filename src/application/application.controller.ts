import { Controller, Put, Post, UseGuards, Param, Req, Get, Body } from '@nestjs/common';
...
export class ApplicationController {
    ...
    async updateStatus(@Param('id') id: string, @Body() updateStatusDto: UpdateStatusDto) {
        const updatedApplication = await this.applicationService.updateStatus(id,updateStatusDto);
