import { Controller, Post, Body, Res, Get, Put, Req, UseGuards } from '@nestjs/common';
...
export class UserController {
    ...
    @Put('updateProfile')
    async updateProfile(@Req() req: any,@Body() updateUserDto: UpdateUserDto,@Res() res: Response) {
        try {
